...
const PrivateSale: NextPage = () => {
  ...
  useEffect(() => {
    if (typeof (window as any).ethereum !== 'undefined') {
      ...
      const contract = new ethers.Contract(config.testnet.MHTPrivateSale.address, MHTPrivateSaleJson.abi, signer) as MHTPrivateSale
  ...
  const onClick = () => {
    if(contract && wallet) {
      contract?.buyTokens(wallet, {value: ethers.utils.parseEther(value.toString())})
    }
  }
